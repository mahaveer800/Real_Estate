...
const [result, setResult] = React.useState("");
  ...
  viewport={{ once: false, amount: 0.2 }}
    ...
    <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>Ready to Make a Move? Let's Build Your Future Togethet</p>
     ...
     <form onSubmit={onSubmit} className='max-w-2xl mx-auto text-gray-600 pt-8'>
        <div className='flex flex-wrap' >
            ...
            <div className='w-full md:w-1/2 text-left  ' >Your Email
               <input className='w-full border border-gray-300 rounded px-4 py-3 mt-2 mx-2' type='email' name='Email' placeholder='Your Email' required/>
            </div>
        </div>
