...
const prevProject = ()=>{
  ...
  viewport={{ once: false, amount: 0.2 }}
    ...
    className='container mx-auto py-4 pt-20 px-6 md:px-20 lg:px-32 my-20 w-full overflow-hidden' id='Projects'>
        ...
        <p className='text-center text-gray-500 mb-8 max-w-80 mx-auto'>Crafting Spaces, Building Legacies-Explore Over Portfolio</p>
        ...
        >
            {projectsData.map((project, index)=>(
                <div key={index} className='relative flex-shrink-0 w-full sm:w-1/4'>
                    <img src={project.image} alt='project.titele' className='w-full h-auto mb-4'/>
