...
const Navbar = () => {
 ...
 <div className='absolute top-0 left-0 w-full z-10'>
  <div className='container mx-auto flex justify-between items-center py-4 px-6 md:px-20 lg:px-32 bg-transparent'>
    ...
    <button className='hidden md:block bg-blue-100 px-8 py-2 rounded-full'>Sign up</button>
   <img 
...
/>
 ...
 {/* --------mobile view-------- */}
   <div className={`md:hidden ${showMobileMenu ? 'fixed w-full h-full' : 'h-0 w-0' }  right-0 top-0 bottum-0 overflow-hidden bg-white transition-all`}>
